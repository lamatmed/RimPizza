          ...
          catalogProducts: {
            items: catalog.catalogProducts.items.map(
              (item: { localizeInfos: { title: string } }) => ({
                ...item,
                localizeInfos: {
                  title: item.localizeInfos?.title || 'Titre par défaut',
                },
              })
            ),
          },
            ...
            <div className='text-center lg:text-left space-y-6 lg:space-y-8'>
              <div className='space-y-4'>
                ...
                <p className='text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0'>
                  Découvrez le goût de l'Italie avec nos pizzas cuites au feu de bois préparées avec les meilleurs ingrédients. Pâte fraîche, garnitures premium et mozzarella fondante à chaque bouchée.
                </p>
              </div>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12 sm:mb-16'>
            <h2 className='text-3xl sm:text-4xl lg:text-5xl font-black mb-3 sm:mb-4'>
              <span className='bg-gradient-to-r from-red-600 via-orange-500 to-yellow-500 bg-clip-text text-transparent'>
                Pourquoi Choisir SahandPizza ?
              </span>
            </h2>
            <p className='text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4'>
              Nous ne sommes pas qu'une simple pizzeria. Nous sommes passionnés par la livraison de saveurs italiennes authentiques directement à votre porte.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8'>
            {[
              {
                icon: Pizza,
                title: 'Perfection au Feu de Bois',
                description:
                  'Four traditionnel au feu de bois pour une croûte authentique croustillante et une saveur fumée.',
                color: 'red',
              },
              {
                icon: Clock,
                ...
                description:
                  'Délai de livraison moyen de 25 minutes. Pizza chaude et fraîche quand vous le souhaitez.',
                color: 'orange',
              },
              {
                icon: Heart,
                ...
                description:
                  'Seuls les meilleurs ingrédients italiens, mozzarella importée et herbes fraîches.',
                color: 'yellow',
              },
              {
                icon: Award,
                title: 'Primée',
                description:
                  'Élue meilleure pizza de la ville pendant 3 années consécutives par les critiques culinaires.',
                color: 'red',
              },
            ].map((feature, index) => (
      ...
      <section className='py-16 sm:py-20 bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50 dark:from-orange-950/20 dark:via-red-950/20 dark:to-yellow-950/20'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12 sm:mb-16'>
            ...
            <p className='text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4'>
              Ne nous croyez pas sur parole - écoutez nos amoureux de pizza satisfaits !
            </p>
          </div>
            ...
            {[
              {
                ...
                rating: 5,
                text: "La meilleure pizza que j'ai jamais mangée ! La croûte au feu de bois est parfaite et les ingrédients ont un goût si frais. Je commanderai certainement à nouveau !",
              },
              {
                name: 'Mike Chen',
                ...
                rating: 5,
                text: "Livraison rapide, pizza chaude et saveurs incroyables. SahandPizza est devenu le choix de notre famille pour les soirées pizza !",
              },
              {
                name: 'Emma Wilson',
                ...
                rating: 5,
                text: 'Un goût italien authentique qui me rappelle mon voyage à Naples. La pizza margherita est absolument divine !',
              },
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center text-white'>
            {[
              ...
              { icon: Pizza, number: '100,000+', label: 'Pizzas Livrées' },
              { icon: Award, number: '15+', label: 'Prix Remportés' },
              { icon: Clock, number: '5', label: "Années d'Excellence" },
            ].map((stat, index) => (
              <div key={index} className='group'>
          ...
          <div className='grid lg:grid-cols-2 gap-8 lg:gap-12 items-center'>
            <div>
              ...
              <p className='text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed'>
                Venez voir nos maîtres pizzaiolos en action ! Regardez-nous préparer la pâte fraîche et enfourner nos pizzas dans nos fours traditionnels au feu de bois.
              </p>
              ...
              <div className='space-y-4 sm:space-y-6'>
                ...
                <div className='flex items-center space-x-3 sm:space-x-4'>
                  ...
                  <div>
                    ...
                    <div className='text-xs sm:text-sm text-gray-600 dark:text-gray-400'>
                      Ouvert de 11h à 23h Tous les Jours
                    </div>
                  </div>
                </div>
                ...
                <div className='absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white'>
                  <div className='flex items-center space-x-2 mb-1 sm:mb-2'>
                    ...
                    <span className='font-semibold text-sm sm:text-base'>
                      Maître Pizzaiolo Antonio
                    </span>
                  </div>
                  <p className='text-xs sm:text-sm opacity-90'>
                    25+ ans de cuisine italienne authentique
                  </p>
                </div>
              </div>
            </div>
        ...
        {isLoading && (
          <div className='flex flex-col justify-center items-center h-48 sm:h-64 space-y-4'>
            ...
            <p className='text-base sm:text-lg font-medium text-gray-600 dark:text-gray-300 text-center'>
              Chargement des délicieuses pizzas...
            </p>
          </div>
        )}
